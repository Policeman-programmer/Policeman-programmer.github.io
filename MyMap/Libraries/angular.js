 ...
 * interpolation markersOnTheMap will be preserved in the final string.
 *
...
function $CompileProvider($provide, $$sanitizeUriProvider) {
  ...
  this.$get = [
     ...
     * and therefore requires DOM nodes between -start and -end markersOnTheMap to be grouped
     * together.
     *
     * @param {string} name name of the directive to look up.
